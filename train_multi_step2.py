...
def main(args):
    ...
    if args.finetune and (not args.eval):
        ...
        config_lora_2 = LoraConfig(
            r=8,  # LoRA的秩
            lora_alpha=16,  # LoRA的alpha参数, scaling=alpha/r
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        print(f"Val loss total: {val_loss_total}, Scheduler best: {scheduler.best}")
